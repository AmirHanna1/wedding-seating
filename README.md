...
It's also useful for ushers — instead of flipping through a printed list, they can just type a guest's name and direct them to the right table. Even at just 20 seconds per guest scanning a printed list, that's 100 minutes of cumulative lookup time at a 300-person wedding. It creates lines at the door and a frustrating first impression. A search bar makes it instant.
